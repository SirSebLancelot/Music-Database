...
class DataListBox(Scrollbox):
    ...
    def __init__(self, window, connection, table, field, sort_order=(), **kwargs):
        ...
        self.linked_box = None      # default to None so no link to start with
        ...
        self.bind('<<ListboxSelect>>', self.on_select)     # whenever artist clicked we call on_select method
    ...
    def requery(self, link_value=None):
        ...
        if self.linked_box:
            self.linked_box.clear()     # clear previous albums songs when selecting new artist
    ...
    def on_select(self, event):
        ...
        # get the artists ID from database row
...
if __name__ == '__main__':
    ...
    mainWindow.rowconfigure(1, weight=5)    # more weight for middle rows, contain list boxes
